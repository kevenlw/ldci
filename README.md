...
* 进入网站http://rdf.tools => _ASN_ => _Configure_ => _Load ASN File_ => _选择已有文档_ => 点击 [D2695955.json](https://github.com/dcmi/ldci/blob/master/docs/D2695955.json).  
    * The editor displays green if the JSON file has parsed correctly.如果JSON文档解析正确的话，编辑显示为绿色。
